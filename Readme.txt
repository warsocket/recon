...
The input is written to the STDIN of the script and the OUTPUT read from the STDOUT, IP'a and A records are delimited by newlines.

You can run a number of scripts to generate 'candidate' results which get imported back in the main result set through the use of filters.
...
Get certificates through CT of example.com and example.org and add them to the working set.
